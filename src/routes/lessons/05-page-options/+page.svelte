...
<style>
	...
	.opt-card:last-child { border-right: none; }

	.opt-what { background: rgba(88,166,255,0.04); }
	.opt-fails { background: rgba(248,81,73,0.04); }
	.opt-when { background: rgba(63,185,80,0.04); }
	...
	.matrix-table tr:hover td { background: var(--color-surface-2); }
