...
>
	...
	<div class="gap-4 mb-12 grid grid-cols-1">
		<div class="p-6 rounded-xl border-white/10 bg-white/5 glass-blur space-y-4 border">
			...
			<p class="text-xs text-white/50 leading-relaxed italic">
				Any file containing <code class="text-white/70">.server</code> in its name (e.g.
				<code class="text-white/70">secrets.server.ts</code>) is strictly stripped from the client
				bundle.
			</p>
		</div>
		<div class="p-6 rounded-xl border-white/10 bg-white/5 glass-blur space-y-4 border">
			...
			<p class="text-xs text-white/50 leading-relaxed italic">
				The entire <code class="text-white/70">src/lib/server</code> directory is a protected zone. SvelteKit
				will throw a build error if any client-side code tries to import from here.
			</p>
		</div>
		<div class="p-6 rounded-xl border-white/10 bg-white/5 glass-blur space-y-4 border">
			<div class="gap-3 flex items-center">
			...
			<p class="text-xs text-white/50 leading-relaxed italic">
				Modules like <code class="text-white/70">$env/static/private</code> enforce that sensitive environment
				variables NEVER reach the browser.
			</p>
		</div>
	</div>
