...
>
	...
	<div class="p-8 rounded-xl border-white/10 bg-white/5 glass-blur space-y-4 mb-12 border">
		<p class="text-sm text-white/70 leading-relaxed">
			Running <code class="px-1.5 py-0.5 rounded bg-white/10 text-white font-mono"
				>npx svelte-package</code
			>
			takes the contents of your
			<code class="px-1.5 py-0.5 rounded bg-white/10 text-white font-mono">src/lib</code>
			directory and generates a
			<code class="px-1.5 py-0.5 rounded bg-white/10 font-mono text-(--color-accent)">dist</code> folder.
		</p>
		<p class="text-sm text-white/50 leading-relaxed italic">
			This folder contains all code and type definitions formatted correctly for publishing to <strong
				>npm</strong
			>.
		</p>
	</div>
