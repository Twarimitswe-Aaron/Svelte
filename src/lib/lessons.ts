...
export const lessons: Lesson[] = [
	{
		...
		description:
			'Understand what SvelteKit is, how it differs from plain Svelte, and explore every file in a project.',
	...
	},
	{
		...
		description:
			'Understanding the purpose of every file in a SvelteKit project: +page, +layout, +server, and more.',
	...
	},
	{
		...
		title: 'Routing',
		description:
			'File-based routing using +page.svelte, +layout.svelte, dynamic [param] segments, and the +error.svelte boundary.',
	...
	},
	{
		...
		title: 'Loading Data',
		description:
			'Server-only load(), universal load(), params, streaming with #await blocks, and parent data.',
	...
	},
	{
		...
		title: 'Form Actions',
		description:
			'Default & named actions, anatomy of an action, validation errors, use:enhance for progressive enhancement.',
	...
	},
	{
		...
		title: 'Page Options',
		description:
			'Control rendering modes: prerender, ssr, csr, and trailingSlash — and know when to use each.',
	...
	},
	{
		...
		description:
			'Context API, URL state, component state preservation, and ephemeral snapshot storage.',
	...
	},
	{
		...
		description:
			'Rest params, optional params, route matchers, layout groups with (group) notation, and breaking out of layouts.',
	...
	},
	{
		...
		title: 'Hooks',
		description:
			'Server hooks: handle, handleError, handleFetch, locals. Universal hooks: reroute, transport.',
	...
	},
	{
		...
		description:
			'Expected errors with error(), unexpected errors, +error.svelte pages, and the handleError hook.',
	...
	},
	{
		...
		description:
			'Create REST endpoints with +server.ts. Handle GET, POST, DELETE and understand content negotiation.',
	...
	},
	{
		...
		description:
			'query, form, command, and prerender from $app/server — server logic callable directly from components via auto-generated HTTP endpoints.',
	...
	},
	{
		...
		title: 'Link Options',
		description:
			'Preloading data, code, or disabling scroll on links using data-sveltekit-* attributes.',
	...
	},
	{
		...
		description:
			'Protecting server-side secrets using $env/static/private and server-only modules.',
	...
	},
	{
		...
		title: 'Packaging',
		description:
			'Creating reusable Svelte and SvelteKit component libraries using @sveltejs/package.',
	...
	},
	{
		...
		description:
			'Icons, Images, SEO meta tags, non-blocking fonts, sitemap.xml, robots.txt, accessibility, and auth integration — all in one lesson.',
	...
	},
	{
		...
		description:
			'Unit testing Svelte components and SvelteKit modules using Vitest and @testing-library/svelte.',
